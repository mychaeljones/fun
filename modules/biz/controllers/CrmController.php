...
class CrmController extends Zend_Controller_Action {
    ...
    public function getLeadsAction() {               
       ...
       //echo $start; echo $end;        
        $result['rows'] = $this->_users->getUsersPage ('Lead', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);
        
        $total = $this->_users->getUsersTotal('Lead', $rep, $potential,$source, $soldBy, $lastAttempt);
    ...
    public function getProspectAction() {       
       ...
       //echo $start; echo $end;        
        $result['rows'] = $this->_users->getUsersPage ('Prospect', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);
        
        $total = $this->_users->getUsersTotal('Prospect', $rep, $potential,$source, $soldBy, $lastAttempt);
        $result['total'] = $total['total'];
    ...
    public function getAccountsAction() {
        ...
        //echo $start; echo $end;        
        $result['rows'] = $this->_users->getUsersPage('Account', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);

        $total = $this->_users->getUsersTotal('Account', $rep, $potential, $source, $soldBy, $lastAttempt);
        $result['total'] = $total['total'];
...
*/
  /*  public function accountsAction() {               
   ...
   {       
       if ($this->_getParam('category') == 'all' && strlen($this->_getParam('query')) < 2) {
