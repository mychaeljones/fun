...
//class Application_Service_AuthorizeNetCIM extends AuthorizeNetRequest
class Application_Service_AuthorizeNetCIM extends Application_Service_AuthorizeNetRequest
{
    ...
    private function _constructXml($request_type)
    {
        $string = '<?xml version="1.0" encoding="utf-8"?>
            <'.$request_type.' xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
            </'.$request_type.'>';
...
class AuthorizeNetCIM_Response extends Application_Service_AuthorizeNetXMLResponse
{
    /**
    ...
    {
        return new AuthorizeNetCIM_Response($this->_getElementContents("directResponse"), ",", "", array());
    }
