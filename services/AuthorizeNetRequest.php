...
abstract class Application_Service_AuthorizeNetRequest
{
   ...
   // protected $_log_file = false;
    ...
    {            
        ...
        $authnet = $config->toArray();
        $this->_api_login  = $authnet['authnetlogin'];
        $this->_transaction_key = $authnet['authnetpassword'];      
     ...
     //   $this->_transaction_key = ($transaction_key ? $transaction_key : (defined('AUTHORIZENET_TRANSACTION_KEY') ? AUTHORIZENET_TRANSACTION_KEY : ""));
       ...
       // $this->_log_file = 'log';
        $this->_log_file = 'log/authnet/'.date("Ymd");
    }
